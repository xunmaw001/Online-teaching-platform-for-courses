            ...
            <div class="ng-inmod-ini">
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">作业唯一编号</label>
                          <div class="layui-input-inline">
                              <input type="text" name="zuoyeUuidNumber" id="zuoyeUuidNumber" placeholder="作业唯一编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="zuoyeName" id="zuoyeName" placeholder="作业名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function banjiTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=banji_types", 'get', {}, function (res) {
                if(res.code == 0){
        ...
        function zuoyeTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=zuoye_types", 'get', {}, function (res) {
                if(res.code == 0){
                    vue.zuoyeTypesList = res.data.list;
                }
            });
        }
        ...
        function pageList() {
            ...
            if (jquery('#zuoyeUuidNumber').val() != null && jquery('#zuoyeUuidNumber').val() != "" && jquery('#zuoyeUuidNumber').val() != "null" ) {
                param['zuoyeUuidNumber'] = jquery('#zuoyeUuidNumber').val();
            }
         
            if (jquery('#zuoyeName').val() != null && jquery('#zuoyeName').val() != "" && jquery('#zuoyeName').val() != "null" ) {
                param['zuoyeName'] = jquery('#zuoyeName').val();
            }
                                        

            // 获取列表数据
            http.request('zuoye/list', 'get', param, function(res) {
