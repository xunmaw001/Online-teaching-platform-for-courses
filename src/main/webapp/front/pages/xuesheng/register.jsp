            ...
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">学号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="xueshengUuidNumber" id="xueshengUuidNumber"  placeholder="学号"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">学生姓名:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="xueshengName" id="xueshengName"  placeholder="学生姓名"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
<!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">学生手机号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="xueshengPhone" id="xueshengPhone"  lay-verify="phone|required"   placeholder="学生手机号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
  <!-- 身份证号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">学生身份证号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="xueshengIdNumber" id="xueshengIdNumber"  lay-verify="identity|required"   placeholder="学生身份证号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                  <div class="layui-form-item layui-form-text input">
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">班级:</span>
                        <div class="layui-input-inline">
                            <select name="banjiTypes" id="banjiTypes" lay-filter="banjiTypes" style="width: 600px;">
...
<!-- 邮箱 -->
                <div class="layui-form-item" pane>
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="xueshengEmail" id="xueshengEmail"  lay-verify="email|required"   placeholder="电子邮箱" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
