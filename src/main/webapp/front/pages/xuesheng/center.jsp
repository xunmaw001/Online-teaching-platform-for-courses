    ...
    <ul class="layui-nav layui-nav-tree">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="xueshengUuidNumber" id="xueshengUuidNumber" lay-verify="required" placeholder="学号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="xueshengName" id="xueshengName" lay-verify="required" placeholder="学生姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="xueshengPhone" id="xueshengPhone"  lay-verify="required|phone"   placeholder="学生手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="xueshengIdNumber" id="xueshengIdNumber"  lay-verify="required|identity"   placeholder="学生身份证号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="xueshengPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="xueshengPhoto" name="xueshengPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="banjiTypes" id="banjiTypes">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="xueshengEmail" id="xueshengEmail"  lay-verify="required|email"   placeholder="电子邮箱" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`xuesheng/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#xueshengPhotoImg").attr("src", data.data.xueshengPhoto);
                });
