                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="xueshengUuidNumber" id="xueshengUuidNumber" placeholder="学号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="xueshengName" id="xueshengName" placeholder="学生姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#xueshengUuidNumber').val() != null && jquery('#xueshengUuidNumber').val() != "" && jquery('#xueshengUuidNumber').val() != "null" ) {
                param['xueshengUuidNumber'] = jquery('#xueshengUuidNumber').val();
            }
         
            if (jquery('#xueshengName').val() != null && jquery('#xueshengName').val() != "" && jquery('#xueshengName').val() != "null" ) {
                param['xueshengName'] = jquery('#xueshengName').val();
            }
