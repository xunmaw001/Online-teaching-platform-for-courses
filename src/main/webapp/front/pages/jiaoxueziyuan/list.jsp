        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-fff">
            <div class="ng-inmod-ini">
                    <div class="index_titlebox">
                        <h3 class="index_title">教学资源展示</h3>
                ...
                <div class="ng-inside-box ng-fault ng-container" aos="fade-up">
                    <div style="margin-top: 2em;">
                        <div v-for="(item,index) in dataList" v-bind:key="index"  class="col-md-3 list-grid">
                            <div @click="jumpCheck('../jiaoxueziyuan/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="list-img">
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            // 获取列表数据
            http.request('jiaoxueziyuan/list', 'get', param, function(res) {
