    ...
    <ul class="layui-nav layui-nav-tree">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="laoshiName" id="laoshiName" lay-verify="required" placeholder="老师姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="laoshiPhone" id="laoshiPhone"  lay-verify="required|phone"   placeholder="老师手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="laoshiPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="laoshiPhoto" name="laoshiPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="laoshiEmail" id="laoshiEmail"  lay-verify="required|email"   placeholder="电子邮箱" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`laoshi/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#laoshiPhotoImg").attr("src", data.data.laoshiPhoto);
                });
