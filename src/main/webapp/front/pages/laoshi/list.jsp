                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="laoshiName" id="laoshiName" placeholder="老师姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#laoshiName').val() != null && jquery('#laoshiName').val() != "" && jquery('#laoshiName').val() != "null" ) {
                param['laoshiName'] = jquery('#laoshiName').val();
            }
                                        

            // 获取列表数据
            http.request('laoshi/list', 'get', param, function(res) {
