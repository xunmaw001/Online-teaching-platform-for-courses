...
<div id="app">
    ...
    <div class="ng-container ng-fault">
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="show-reel">
                        <div v-for="(item,index) in jiaoxueziyuanList" v-bind:key="index" class="col-md-3 agile-gallery-grid">
                            <div class="agile-gallery">
                                <a @click="jumpCheck('../jiaoxueziyuan/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="lsb-preview" data-lsb-group="header">
                                    <img :src="item.jiaoxueziyuanPhoto?item.jiaoxueziyuanPhoto.split(',')[0]:''" style="height: 350px;width:100%;" />
                                    <div class="agileits-caption">
                                        <h4>{{item.jiaoxueziyuanName}}</h4>
                                        <p v-if="item.jiaoxueziyuanNewMoney != null" >￥{{item.jiaoxueziyuanNewMoney}}</p>
                                    </div>
                                </a>
                            </div>
                        </div>
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                    <div class="index_titlebox">
                        <h3 class="index_title">公告展示</h3>
                        <p class="index_intro">DATA SHOW</p>
                    </div>
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="show-reel">
                        <div v-for="(item,index) in gonggaoList" v-bind:key="index" class="col-md-3 agile-gallery-grid">
                            <div class="agile-gallery">
                                <a @click="jumpCheck('../gonggao/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="lsb-preview" data-lsb-group="header">
                                    <img :src="item.gonggaoPhoto?item.gonggaoPhoto.split(',')[0]:''" style="height: 350px;width:100%;" />
                                    <div class="agileits-caption">
                                        <h4>{{item.gonggaoName}}</h4>
                                        <p v-if="item.gonggaoNewMoney != null" >￥{{item.gonggaoNewMoney}}</p>
                                    </div>
                                </a>
                            </div>
                        </div>
