    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑教学资源留言</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑教学资源留言</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">教学资源留言信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="xueshengId" name="xueshengId" type="hidden">
                                    <div class="form-group col-md-6 jiaoxueziyuanLiuyanTextDiv">
                                        <label>留言内容</label>
                                        <textarea style="width: 450px"  id="jiaoxueziyuanLiuyanText" name="jiaoxueziyuanLiuyanText" class="form-control"placeholder="留言内容"></textarea>
                                    </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("jiaoxueziyuanLiuyan/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addjiaoxueziyuanLiuyan');
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                xueshengId: "required",
                jiaoxueziyuanLiuyanText: "required",
                replyText: "required",
            },
            messages: {
                jiaoxueziyuanId: "教学资源不能为空",
                xueshengId: "学生不能为空",
                jiaoxueziyuanLiuyanText: "留言内容不能为空",
                replyText: "回复内容不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addjiaoxueziyuanLiuyan = window.sessionStorage.getItem("addjiaoxueziyuanLiuyan");
        if (addjiaoxueziyuanLiuyan != null && addjiaoxueziyuanLiuyan != "" && addjiaoxueziyuanLiuyan != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("jiaoxueziyuanLiuyan/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#jiaoxueziyuanLiuyanText").val(ruleForm.jiaoxueziyuanLiuyanText);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            $('#jiaoxueziyuanLiuyanText').attr('readonly', 'readonly');
