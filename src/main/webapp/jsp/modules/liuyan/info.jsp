            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">留言板登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="xueshengId" name="xueshengId" v-model="ruleForm.xueshengId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="liuyanName" name="liuyanName" class="form-control"
                                               v-model="ruleForm.liuyanName" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>留言内容</label>
                                        <input style="width: 450px" id="liuyanText" name="liuyanText" class="form-control"
                                               v-model="ruleForm.liuyanText" readonly>
                                    </div>
