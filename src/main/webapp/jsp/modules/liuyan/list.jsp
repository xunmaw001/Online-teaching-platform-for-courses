...
<!--/Pre Loader -->
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">留言板列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">留言板列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="liuyanNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="留言标题" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //留言标题
            var liuyanNameSearchInput = $('#liuyanNameSearch');
            if( liuyanNameSearchInput != null){
                if (liuyanNameSearchInput.val() != null && liuyanNameSearchInput.val() != '') {
                    searchForm.liuyanName = $('#liuyanNameSearch').val();
                }
            }
                                getDataList();
        }
        ...
        function getDataList() {
            http("liuyan/page", "GET", {
                ...
                liuyanDelete: 1,
                //本表的
                liuyanName: searchForm.liuyanName,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //留言标题
            var liuyanNameCell = document.createElement('td');
            liuyanNameCell.innerHTML = item.liuyanName;
            row.appendChild(liuyanNameCell);


            //留言内容
            var liuyanTextCell = document.createElement('td');
            liuyanTextCell.innerHTML = item.liuyanText;
            row.appendChild(liuyanTextCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("liuyan/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addliuyan", "addliuyan");
            window.location.href = "add-or-update.jsp"
        }
