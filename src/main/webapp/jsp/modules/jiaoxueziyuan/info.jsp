            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">教学资源登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="laoshiId" name="laoshiId" v-model="ruleForm.laoshiId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jiaoxueziyuanUuidNumber" name="jiaoxueziyuanUuidNumber" class="form-control"
                                               v-model="ruleForm.jiaoxueziyuanUuidNumber" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jiaoxueziyuanName" name="jiaoxueziyuanName" class="form-control"
                                               v-model="ruleForm.jiaoxueziyuanName" readonly>
                                    </div>

                                <div class="form-group col-md-6">
                                    <label>教学资源照片</label>
                                    <img id="jiaoxueziyuanPhotoImg" width="100" height="100">
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>赞</label>
                                        <input style="width: 450px" id="zanNumber" name="zanNumber" class="form-control"
                                               v-model="ruleForm.zanNumber" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="caiNumber" name="caiNumber" class="form-control"
                                               v-model="ruleForm.caiNumber" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input style="width: 450px" id="jiaoxueziyuanValue" name="jiaoxueziyuanValue" class="form-control"
                                           v-model="ruleForm.jiaoxueziyuanValue" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>点击次数</label>
                                        <input style="width: 450px" id="jiaoxueziyuanClicknum" name="jiaoxueziyuanClicknum" class="form-control"
                                               v-model="ruleForm.jiaoxueziyuanClicknum" readonly>
                                    </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "jiaoxueziyuan/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.jiaoxueziyuanContent != null && ruleForm.jiaoxueziyuanContent != 'null' && ruleForm.jiaoxueziyuanContent != '') {
            var jiaoxueziyuanContentUeditor = UE.getEditor('jiaoxueziyuanContentEditor');
                jiaoxueziyuanContentUeditor.ready(function () {
                    ...
                    jiaoxueziyuanContentUeditor.setDisabled('fullscreen');
            });
        }
    }
    ...
    function setDownloadBtn() {
        var jiaoxueziyuanFileUrl = "download('" + ruleForm.jiaoxueziyuanFile + "')";
        $("#jiaoxueziyuanFile").attr("onclick", jiaoxueziyuanFileUrl);
