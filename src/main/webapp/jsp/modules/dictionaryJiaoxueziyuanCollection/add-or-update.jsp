    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑收藏表类型</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">收藏表类型管理</li>
                        <li class="breadcrumb-item active">编辑收藏表类型</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">收藏表类型表信息</h3>
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="codeIndex" name="codeIndex" class="form-control"
                                           onchange="codeIndexChickValue(this)" readonly  placeholder="编码">
                                </div>
...
<script>
    ...
    var tableName = "dictionaryJiaoxueziyuanCollection";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "jiaoxueziyuan_collection_types";
            data["dicName"] = "收藏表类型";
    ...
    function getDetails() {
        ...
        if (adddictionary != null && adddictionary != "" && adddictionary != "null") {
            ...
            $(validform());
            $('#submitBtn').text('新增');
            httpJson("dictionary/maxCodeIndex" , "POST", {"dicCode":"jiaoxueziyuan_collection_types"}, (res) => {
                if(res.code == 0){
                    $("#codeIndex").val(res.maxCodeIndex);
                }
            });
