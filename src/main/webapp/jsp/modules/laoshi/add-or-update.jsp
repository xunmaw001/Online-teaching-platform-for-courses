                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 laoshiNameDiv">
                                        <label>老师姓名</label>
                                        <input style="width: 450px" id="laoshiName" name="laoshiName" class="form-control"
                                               placeholder="老师姓名">
                                    </div>
                                    <div class="form-group col-md-6 laoshiPhoneDiv">
                                        <label>老师手机号</label>
                                    ...
                                    <div class="form-group col-md-6 laoshiPhotoDiv">
                                        <label>老师头像</label>
                                    ...
                                    <div class="form-group col-md-6 laoshiEmailDiv">
                                        <label>电子邮箱</label>
