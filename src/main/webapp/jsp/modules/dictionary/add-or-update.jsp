            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑字典</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">字典信息</h3>
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                            <!-- 级联表的字段 -->
                            <!-- 当前表的字段 -->
                                    <input id="updateId" name="id" type="hidden">
                                    <div class="form-group col-md-6 dicCodeDiv">
                                        <label>字段</label>
                                        <input style="width: 450px" id="dicCode" name="dicCode" class="form-control"
                                               placeholder="字段">
                                    </div>
                                    <div class="form-group col-md-6 dicNameDiv">
                                        <label>字段名</label>
                                        <input style="width: 450px" id="dicName" name="dicName" class="form-control"
                                               placeholder="字段名">
                                    </div>
                                    <div class="form-group col-md-6 codeIndexDiv">
                                        <label>编码</label>
                                        <input style="width: 450px" id="codeIndex" name="codeIndex" class="form-control"
                                               onchange="codeIndexChickValue(this)"  placeholder="编码">
                                    </div>

                                    <div class="form-group col-md-6 indexNameDiv">
                                        <label>编码名字</label>
                                        <input style="width: 450px" id="indexName" name="indexName" class="form-control"
                                               placeholder="编码名字">
                                    </div>
                                <input id="superId" name="superId" type="hidden">
                                    <div class="form-group col-md-6 beizhuDiv">
                                        <label>备注</label>
                                        <input style="width: 450px" id="beizhu" name="beizhu" class="form-control"
                                               placeholder="备注">
                                    </div>
