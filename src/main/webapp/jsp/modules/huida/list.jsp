                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">回答列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        作业唯一编号
                                        <div class="layui-input-inline">
                                            <input type="text" id="zuoyeUuidNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="作业唯一编号" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
            ...
            if( xueshengNameSearchInput != null){
                if (xueshengNameSearchInput.val() != null && xueshengNameSearchInput.val() != '') {
                    searchForm.xueshengName = $('#xueshengNameSearch').val();
                            ...
                            //作业唯一编号
            var zuoyeUuidNumberSearchInput = $('#zuoyeUuidNumberSearch');
            if( zuoyeUuidNumberSearchInput != null){
                if (zuoyeUuidNumberSearchInput.val() != null && zuoyeUuidNumberSearchInput.val() != '') {
                    searchForm.zuoyeUuidNumber = $('#zuoyeUuidNumberSearch').val();
                }
            }
        ...
        function getDataList() {
            ...
            //级联表的
                ...
                zuoyeUuidNumber: searchForm.zuoyeUuidNumber,
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(zuoyeTypesCell);
                ...
                //回答文件
            var huifuFileCell = document.createElement('td');
            if(item.huifuFile ==null || item.huifuFile == '' || item.huifuFile == 'null'){
                    huifuFileCell.innerHTML = '没有下载文件';
            }else {
                var huifuFileFile = document.createElement('button');
                    huifuFileFile.innerHTML = '下载';
                var huifuFileFileAttr = "download('" + item.huifuFile + "')"
                    huifuFileFile.setAttribute('onclick',huifuFileFileAttr);
                    huifuFileCell.appendChild(huifuFileFile);
            }
            row.appendChild(huifuFileCell);


            //作业得分
            var huidaDefenCell = document.createElement('td');
            huidaDefenCell.innerHTML = item.huidaDefen;
            row.appendChild(huidaDefenCell);
            ...
            if(window.sessionStorage.getItem("role") == "老师" && (item.huidaDefen == null || item.huidaDefen == "")){
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("huida/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addhuida", "addhuida");
            window.location.href = "add-or-update.jsp"
        }
