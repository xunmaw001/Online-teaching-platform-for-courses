            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">作业登记</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.zuoyeContent != null && ruleForm.zuoyeContent != 'null' && ruleForm.zuoyeContent != '') {
            var zuoyeContentUeditor = UE.getEditor('zuoyeContentEditor');
                zuoyeContentUeditor.ready(function () {
                    ...
                    zuoyeContentUeditor.setDisabled('fullscreen');
            });
        }
    }
    ...
    function setDownloadBtn() {
        var zuoyeFileUrl = "download('" + ruleForm.zuoyeFile + "')";
        $("#zuoyeFile").attr("onclick", zuoyeFileUrl);
