...
public class JiaoxueziyuanLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JiaoxueziyuanLiuyanEntity() {

	}

	public JiaoxueziyuanLiuyanEntity(T t) {
		try {
    ...
    public String toString() {
        return "JiaoxueziyuanLiuyan{" +
            "id=" + id +
            ", jiaoxueziyuanId=" + jiaoxueziyuanId +
            ", xueshengId=" + xueshengId +
            ", jiaoxueziyuanLiuyanText=" + jiaoxueziyuanLiuyanText +
