...
public class JiaoxueziyuanCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JiaoxueziyuanCollectionEntity() {

	}

	public JiaoxueziyuanCollectionEntity(T t) {
		try {
    ...
    public String toString() {
        return "JiaoxueziyuanCollection{" +
            "id=" + id +
            ", jiaoxueziyuanId=" + jiaoxueziyuanId +
            ", xueshengId=" + xueshengId +
            ", jiaoxueziyuanCollectionTypes=" + jiaoxueziyuanCollectionTypes +
